...
# Vercel-এর জন্য সঠিক import: ApplicationBuilder এখন Application হয়ে গেছে
...
# ---
# গ্লোবাল ভেরিয়েবল লোড (Vercel-এর জন্য আবশ্যক)
# ---
# Vercel-এর Environment Variable লোড করা হচ্ছে।
# "8028816575:..." এই টোকেনটি শুধু যদি ENV Variable না পায়, তবেই ব্যবহার হবে।
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "8028816575:AAGhh5zxgLM2vVczlhqq6K0I-n7tMtnJprs") 
# আপনার কোডে 'TOKEN' ভেরিয়েবল ব্যবহার হয়েছে, তাই আমরা দুটিই ডিফাইন করে দিলাম
...
8. সরবরাহকারীকে বৈধ ও আইনসঙ্গত ডেটা সরবরাহ করতে হবে; কোনো অবৈধ বা অনুমতিহীন ডেটার দায় সরবরাহকারীর।\n\n"""
        ...
        'Hindi': {
            ...
            # নতুন: Alternative Gmail মেসেজ
            'alternative_gmail_privacy': (
                "वैकल्पिक जीमेल सबमिशन के लिए गोपनीयता नीति:\n\n"
...
5. भुगतान: प्रति वैध Gmail अकाउंट 10 টাকা (बीडीटी)।
...
8. आपूर्तिकर्ता को वैध और कानूनी डेटा प्रदान करना होगा; किसी भी अवैध या अनधिकृत डेटा की पूरी जिम्मेदारी आपूर्तिकर्ता की होगी।\n\n"""
            ...
            'new_alternative_submission_admin': "🆕 नया वैकल्पिक জিमेल সাবমিশন\nইউজার আইডি: {uid}\nসাবমিশন আইডি: {submission_id}\nজমা করা লিংক: {link}\nराशि: {amount} रुपये\n\nঅনুমোদনের জন্য, /approve {submission_id} কমান্ডটি ব্যবহার করুন।", 
...
# ---
# বটের মূল কমান্ড এবং হ্যান্ডলার ফাংশন (FUNCTIONS MUST BE DEFINED BEFORE create_application)
# ---
...
# ---
# অ্যাপ্লিকেশন বিল্ডার এবং হ্যান্ডলার রেজিস্ট্রেশন ফাংশন (Vercel-এর জন্য আবশ্যক)
# ---

def create_application():
    """Vercel-এর জন্য Application অবজেক্ট তৈরি করে"""
    # আপনার ভেরিয়েবল TELEGRAM_BOT_TOKEN এখন ডিফাইন করা আছে (উপরে দেখুন)
    application = Application.builder().token(TELEGRAM_BOT_TOKEN).build()
    
    # হ্যান্ডলারগুলো যোগ করা
    application.add_handler(CommandHandler("start", start))
    application.add_handler(CommandHandler([
        "show_users", "see_details", "ban", "unban", 
        "add_balance", "deduct_balance", "add_pending", "deduct_pending", 
        "add_main", "deduct_main", "withdraw", "reject_withdraw", 
        "message", "stop", "start_task", 
        "disable_payment_method", "enable_payment_method", 
        "show_payment_methods", "sendto", "approve", "reject", 
        "update_alternative_price"
    ], admin_command))
...
# Local Running: এই লাইনগুলো Vercel-এ চলবে না, তাই এদেরকে ফাংশনের বাইরে সরানো হয়েছে।
